...
<head>
  ...
  <title>MAPALU | Dashboard</title>
  <!-- Tell the browser to be responsive to screen width -->
  <link rel="shorcut icon" type="text/css" href="<?php echo base_url().'assets/images/ayu.png'?>">
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="http://mapalu.myportfolio.com">MAPALU</a>.</strong> All rights reserved.
  </footer>
