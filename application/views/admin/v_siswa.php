...
<head>
  ...
  <title>MAPALU | Data Anggota</title>
...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Tambah Anggota</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 <a href="http://mapalu.myportfolio.com">MAPALU</a>.</strong> All rights reserved.
  </footer>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnis" class="form-control" id="inputUserName" placeholder="nama jabatan" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Jabatan</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnis" value="<?php echo $mpa;?>" class="form-control" id="inputUserName" placeholder="nama jabatan" required>
                                        </div>
                                    </div>
