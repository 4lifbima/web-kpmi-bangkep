...
<head>
    ...
    <title>Pendaftaran OKM yang Ke-XXVII</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url().'theme/css/slick1-theme.css'?>">
    <link rel="stylesheet" href="<?php echo base_url().'theme/css/owl.carousel.min.css'?>">
    <!-- Main CSS -->
    <link href="<?php echo base_url().'theme/css/styleee.css'?>" rel="stylesheet">
    <style>
        .judul h2 {
            margin-bottom: 0; /* Mengurangi margin bawah h2 */
        }

        .judul i {
        margin-top: 0; /* Menghilangkan margin atas i */
        }

    /* Responsif dasar untuk mobile */
    @media only screen and (max-width: 768px) {
        .welcome_about .container {
        padding: 1rem; /* Tambahkan sedikit padding untuk keterbacaan yang lebih baik di ponsel */
        }
    }

    /* Opsional: Sesuaikan tinggi iframe berdasarkan konten */
    @media only screen and (max-width: 768px) {
        iframe {
        height: 400px; /* Sesuaikan nilai ini sesuai kebutuhan konten formulir Anda */
        }
    }
    </style>
</head>
...
<section class="welcome_about">
    <div class="container">
       <div class="judul mb-3">
        <center><h2>Fromulir Pendaftaran</h2> <br>
       <i>Pendaftaran OKM Yang ke-XXVII</i></center>
       </div>
    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSer2eqzexCOdky3a_2rZTNnaEPAlCajiYp9W9svcRNKlXnDhg/viewform?embedded=true" width="100%" height="926" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
        </div>
    </section>
    <!--//END Pendaftaran -->
        <!--============================= FOOTER =============================-->
