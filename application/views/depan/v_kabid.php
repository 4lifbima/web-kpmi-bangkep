...
<head>
    ...
    <title>Kabid - KPMI-Bangkep</title>
                ...
                <?php foreach ($data->result() as $row) : ?>
                    <div class="col-xs-12 col-sm-4 col-md-2">
                        <div class="admission_insruction">
                          <?php if(empty($row->kabid_photo)):?>
                            <img src="<?php echo base_url().'assets/images/blank.png';?>" class="img-fluid" alt="#">
                          <?php else:?>
                            <img src="<?php echo base_url().'assets/images/'.$row->kabid_photo;?>"  class="img-fluid" alt="#">
                          <?php endif;?>
                            <p class="text-center mt-3"><span><?php echo $row->kabid_nama;?></span>
                                <br>
                                <?php echo $row->kelas_nama;?></p>
                            <p class="text-center mt-1"><?php echo $row->kabid_nis;?></span>
                        </div>
                    </div>
                <?php endforeach;?>
              </div>
